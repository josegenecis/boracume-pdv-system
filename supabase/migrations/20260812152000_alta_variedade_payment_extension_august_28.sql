...
-- O acesso permanece liberado ate o fim de 28/08/2026 (America/Fortaleza)
-- e volta a seguir a regra normal de cobranca na virada para 29/08.
do $$
declare
  v_user_id uuid;
  v_subscription_id uuid;
  v_match_count integer;
  v_access_until timestamptz := timestamptz '2026-08-29 00:00:00-03';
begin
  ...
  select
    ...
    jsonb_build_object(
      ...
      'deadline_local', '2026-08-28 23:59:59 America/Fortaleza',
