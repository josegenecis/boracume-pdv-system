...
const RevenueChart: React.FC<RevenueChartProps> = ({ data }) => {
  ...
  return (
    <Card className="w-full overflow-hidden border-0 shadow-lg bg-gradient-to-br from-background via-background to-muted/10">
      ...
      <CardContent className="p-3 sm:p-6">
        <div className="w-full overflow-x-auto">
          <ChartContainer config={chartConfig} className="h-[250px] sm:h-[350px] w-full min-w-[300px]">
            <AreaChart data={data} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
              ...
              <XAxis 
                dataKey="name" 
                className="text-xs sm:text-sm font-medium fill-muted-foreground"
                tickLine={false}
                axisLine={false}
              ...
              <ChartTooltip 
                content={
                  <ChartTooltipContent 
                    className="min-w-32 sm:min-w-40 bg-background/95 backdrop-blur-md border border-border/50 shadow-xl rounded-xl"
        ...
        <div className="flex justify-center mt-4 sm:mt-6">
          <div className="flex items-center space-x-2 px-3 sm:px-4 py-2 rounded-full bg-primary/10 border border-primary/20">
