    ...
    <header className="fixed inset-x-0 top-0 z-50 border-b border-[#dfe8e1]/80 bg-white/95 backdrop-blur-xl">
      <div className="container flex h-[72px] items-center justify-between">
        ...
        <div className="hidden items-center gap-2 md:flex">
          ...
          <Button asChild className="rounded-xl bg-[#ef6c20] px-5 font-black text-white shadow-lg shadow-orange-200/60 hover:bg-[#dc5c14]"><a href="/login?tab=register" onClick={() => trackMarketing('landing_signup_click', 'header')}>Teste grátis por 14 dias <ArrowRight className="ml-2 h-4 w-4" /></a></Button>
        </div>
