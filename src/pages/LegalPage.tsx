...
const pages = {
  ...
  '/termos': {
    ...
    sections: [
      ...
      ['PopPay — versão 2026-07-v4', 'Ao conectar o PopPay, o titular autoriza o PopSystem a iniciar a conexão OAuth com sua conta Mercado Pago e a criar, consultar, conciliar e solicitar devoluções de pagamentos comandados pelo sistema. PIX e crédito online à vista são apresentados pré-selecionados no aceite, podendo ser desmarcados ou posteriormente desativados. O PIX possui tarifa integrada vigente de 1,99% por transação, com confirmação instantânea após a aprovação. O crédito online aceita somente pagamento à vista e possui a tarifa de processamento definida pelo Mercado Pago para a conta conectada, somada à tarifa operacional PopPay apresentada no aceite, atualmente 0,5% por transação aprovada. No cartão, a confirmação ocorre em tempo real, enquanto a disponibilidade do saldo respeita o prazo contratado pelo titular com o Mercado Pago. Não é oferecido parcelamento. As tarifas incidem sobre o recebível do restaurante e não são acrescentadas ao valor pago pelo consumidor. O aceite fica registrado com versão, canais escolhidos, data e usuário; alterações relevantes exigem novo aceite. A autorização pode ser revogada sem apagar registros cuja conservação seja necessária por obrigação legal, segurança, conciliação ou comprovação de operações realizadas.'],
