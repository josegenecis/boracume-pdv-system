...
<<<<<<< HEAD
          <TabsList className="grid h-auto grid-cols-3 rounded-[18px] border border-[#FF6400]/10 bg-white p-1">
            ...
            <TabsTrigger value="relatorios" className="rounded-xl text-[11px]">DRE</TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="caixa" className="mt-4 space-y-3">
            <div className="grid grid-cols-2 gap-2">
              <div className="rounded-[18px] border border-[#8CC850]/20 bg-white/95 p-3 shadow-sm">
                ...
                <div className="mt-1.5 text-lg font-bold text-slate-900">{formatCurrency(sessionTotal)}</div>
              </div>
              <div className="rounded-[18px] border border-[#003223]/10 bg-white/95 p-3 shadow-sm">
                ...
                <div className="mt-1.5 text-lg font-bold text-slate-900">{formatCurrency(Number(selectedSession?.initial_amount || 0))}</div>
              </div>
              <div className="rounded-[18px] border border-[#8CC850]/20 bg-white/95 p-3 shadow-sm">
                <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-500">PIX</div>
                <div className="mt-1.5 text-lg font-bold text-slate-900">{formatCurrency(sessionPix)}</div>
              </div>
              <div className="rounded-[18px] border border-[#FF6400]/18 bg-white/95 p-3 shadow-sm">
                ...
                <div className="mt-1.5 text-lg font-bold text-slate-900">{formatCurrency(sessionCard)}</div>
              </div>
              <div className="rounded-[18px] border border-[#7C3AED]/18 bg-white/95 p-3 shadow-sm">
                ...
                <div className="mt-1.5 text-lg font-bold text-slate-900">{formatCurrency(sessionCash)}</div>
              </div>
              <div className="rounded-[18px] border border-[#003223]/10 bg-white/95 p-3 shadow-sm">
